...
public class Searches {
	...
	/**
	 * 
	 * @param reservationArray anArray of Reservations
	 * @param nameToFind the Name being searched for.
	 * @return
	 */
	public boolean binarySearch(Reservation[] reservationArray, String nameToFind) {
	...
	/*
	 * I think this is the wrong way to search for the dates since I can't over ride the method with 2 methods only have
	 * the DateAD param and Comparable[] param, I'm thinking I may just use a built in search for those two.
	 */
